...
% - WebAuthn + CTAP2
%  - WebAuthn (W3C-Standard) is a Browser-API for FIDO2-Authentication
%  - CTAP2 establishes communication between WebAuthn and Authenticator
% - Authenticators
%  - Roaming: USB-Keys, Android Device (using NFC), Bluetooth
%  - Integrated: TPM, Windows Hello, TouchID