...
% FIDO-Standards/Protocols
\newacro{fido}[FIDO]{Fast IDentity Online}
\newacro{ctap}[CTAP]{Client to Authenticator Protocol}
\newacro{u2f}[U2F]{Universal Second Factor}
\newacro{uaf}[UAF]{Universal Authentication Framework}
...
% Other Abbreviations
\newacro{2fa}[2FA]{Two-Factor Authentication}
\newacro{mfa}[MFA]{Multi-Factor Authentication}
\newacro{totp}[TOTP]{Time-based One-time Password}
\newacro{hotp}[HOTP]{HMAC-based One-time Password}
\newacro{authn}[authn]{Authentication}
\newacro{auzhz}[authz]{Authorization}
